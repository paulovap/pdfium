...
void* CFX_QtFontInfo::MapFont(int weight, FX_BOOL bItalic, int charset, int pitch_family, const FX_CHAR* cstr_face, FX_BOOL& bExact)
{
...
void* CFX_QtFontInfo::FindFont(int weight, FX_BOOL bItalic, int charset, int pitch_family, const FX_CHAR* family, FX_BOOL bMatchName)
{
...
FX_BOOL CFX_QtFontInfo::ParseFontCfg()
{
    return FALSE;
}
